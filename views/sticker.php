                    ...
                    <div class="svg back" ng-if="sticker.view == 1">
                       ...
                       <svg version="1.1"
                         ...
                         xml:space="preserve">
                           ...
                           <g>
                            <g>
                                <path class="st1" style="fill: #{{sticker.color_1}}" d="M93.4,523.4L93.4,523.4c-10.1,0-18.5-7.7-19.4-17.8l-6.9-78.1c-1.4-15.4,10.8-28.7,26.3-28.7h0
                           ...
                           <g>
                            <path class="st2" style="fill: #{{sticker.color_2}}" d="M557.2,108.6l-92.8-3.2c-34.7-1.2-69.3-1.2-104,0l-92.3,3.2c-32.8,0-59.2,26.6-59.2,59.5v46.6
                           ...
                           <g>
                            <g>
                                <path class="st1" style="fill: #{{sticker.color_1}}" d="M732.3,523.4L732.3,523.4c10.1,0,18.5-7.7,19.4-17.8l6.9-78.1c1.4-15.4-10.8-28.7-26.3-28.7h0
